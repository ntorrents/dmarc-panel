...
INSTALLED_APPS = [
    ...
    # 'rest_framework_simplejwt.token_blacklist',  # Replaced with custom implementation due to UUID foreign key issue
    'jwt_blacklist',  # Custom JWT blacklist with UUID support
    'accounts',
    'corsheaders',
    'drf_yasg',
    'django_filters',
